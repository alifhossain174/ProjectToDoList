            ...
            <div class="col-lg-12">
                <div class="card mt-4">
                    ...
                    <div class="card-body" style="border-left: 1px solid #ADBC7A !important; border-bottom: 1px solid #ADBC7A !important;">
                        <form action="{{url('update/task')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{$task->title}}" id="title" class="form-control" placeholder="Write Task Title Here..." required>
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-3">
                                    <div class="form-group">
                                        <label for="ck_description"><b>Task Description</b></label>
                                        <textarea name="ck_description" id="ck_description" class="form-control">{!! $task->description !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12 text-right mt-2">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-info rounded">Update Task</button>
                                    </div>
                                </div>
                            </div>
                        </form>
